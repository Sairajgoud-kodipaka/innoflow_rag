...
import { Loader2, Mail, Lock, Eye, EyeOff, ArrowRight, Zap, Sparkles, Users, Shield } from "lucide-react"
        ...
        <div className="flex-1 flex items-center justify-center p-8">
          <div className="w-full max-w-md">
            ...
            <div className="text-center mb-10">
              ...
              <p className="text-slate-400 text-lg">Sign in to continue to Innoflow</p>
            </div>
          ...
          <div className="max-w-lg text-center">
            ...
            <div className="space-y-6">
              <div className="flex items-center space-x-4 text-left group">
                ...
                <Zap className="w-5 h-5 text-blue-400 transition-transform group-hover:scale-110" />
              ...
              <div className="flex items-center space-x-4 text-left group">
                ...
                <Sparkles className="w-5 h-5 text-indigo-400 transition-transform group-hover:scale-110" />
                <span className="text-slate-300 text-lg font-medium group-hover:text-white transition-colors">
              ...
              <div className="flex items-center space-x-4 text-left group">
                ...
                <Users className="w-5 h-5 text-violet-400 transition-transform group-hover:scale-110" />
                <span className="text-slate-300 text-lg font-medium group-hover:text-white transition-colors">
              ...
              <div className="flex items-center space-x-4 text-left group">
                ...
                <Shield className="w-5 h-5 text-slate-400 transition-transform group-hover:scale-110" />
                <span className="text-slate-300 text-lg font-medium group-hover:text-white transition-colors">
