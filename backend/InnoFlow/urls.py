...
urlpatterns = [
    ...
    path('api/', include('InnoFlow.ai_integration.urls')),
    ...
    path('api/ai/', include('InnoFlow.ai_integration.urls')),
    path('api/analytics/', include('InnoFlow.analytics.urls', namespace='analytics')),
